...
public class Level2 implements Screen {
    ...
    public Level2(PixelWars game, LevelInfo levelInfo){
        this.game = game;
    ...
    public void show() {
        ...
        btnMiner.addListener(new ClickListener() {
                                 ...
                                 public void clicked(InputEvent event, float x, float y) {
                                     if (gold>= 50 && unidades<20){
                                         minero miner = new minero(myAnimatedCastle.getX()+myAnimatedCastle.getWidth(), myAnimatedCastle.getY(), new Texture("mineroAzulCaminando.png"), new Texture("mineroAzulParado.png"), new Texture("mineroAzulAtacando.png"), 29, 44,29, 44, 34, 38, 50, 10, true, 'p');
        ...
        btnArcher.addListener(new ClickListener() {
                                  ...
                                  public void clicked(InputEvent event, float x, float y) {
                                      if (gold>=100 && unidades < 20){
                                          Archer warrior = new Archer(myAnimatedCastle.getX()+myAnimatedCastle.getWidth(), myAnimatedCastle.getY(), new Texture("arqueroAzulCaminando.png"), new Texture("arqueroAzulParado.png"), new Texture("arqueroAzulAtacando.png"), 29, 44, 43,37,43, 42, 40, 10, true, 'a');
                                          myWarriorsQ.addLast(warrior);
                                          unidades +=1;
                                          gold-=100;
                                          label3.setText(gold);
        ...
        btnMonk.addListener(new ClickListener(){
                                ...
                                public void clicked(InputEvent event, float x, float y) {
                                    if (gold>=500 && unidades <20){
                                        Priest monk = new Priest(myAnimatedCastle.getX()+myAnimatedCastle.getWidth(), myAnimatedCastle.getY(), new Texture("mojeAzulCaminando.png"), new Texture("monjeAzulParado.png"), new Texture("monjeAzulAtacando.png"), 29, 44, 32,44,29, 44, 50, 20, true, 'm');
